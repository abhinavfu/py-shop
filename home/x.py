...
class Product(models.Model):
    ...
    pic1 = models.ImageField(upload_to="media/images/",
                             default=None, blank=True, null=True)
    pic2 = models.ImageField(upload_to="media/images/",
                             default=None, blank=True, null=True)
    pic3 = models.ImageField(upload_to="media/images/",
                             default=None, blank=True, null=True)
    pic4 = models.ImageField(upload_to="media/images/",
                             default=None, blank=True, null=True)
